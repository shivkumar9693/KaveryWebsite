            ...
            <div key={idx} className="glass-panel rounded-xl overflow-hidden group hover:border-brand-red/30 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <Link to={`/products/${item.id}`} className="flex-1 bg-white/5 hover:bg-white/10 py-2 rounded text-sm font-semibold transition-colors flex justify-center items-center gap-1">
